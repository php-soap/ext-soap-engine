...
class DuplicateTypenamesTest extends AbstractSoapTestCase
{
    ...
    function it_knows_how_to_encode_both_types()
    {
        ...
        $this->assertStringContainsString('<input1 xsi:type="ns2:Store"><Attribute1 xsi:type="xsd:string">ok</Attribute1></input1>', $lastRequestInfo->getLastRequest());
        $this->assertStringContainsString('<input2 xsi:type="ns3:Store"><Attribute2 xsi:type="xsd:string">ok</Attribute2></input2>', $lastRequestInfo->getLastRequest());
        $this->assertStringContainsString('<output1 xsi:type="ns2:Store"><Attribute1 xsi:type="xsd:string">ok</Attribute1></output1>', $lastRequestInfo->getLastResponse());
        $this->assertStringContainsString('<output2 xsi:type="ns3:Store"><Attribute2 xsi:type="xsd:string">ok</Attribute2></output2>', $lastRequestInfo->getLastResponse());
    }
    ...
    function it_uses_same_model_for_both_objects()
    {
        ...
        $this->assertStringContainsString('<input1 xsi:type="ns2:Store"><Attribute1 xsi:type="xsd:string">attr1</Attribute1></input1>', $lastRequestInfo->getLastRequest());
        $this->assertStringContainsString('<input2 xsi:type="ns2:Store"><Attribute1 xsi:type="xsd:string">attr1</Attribute1></input2>', $lastRequestInfo->getLastRequest());
        $this->assertStringContainsString('<output1 xsi:type="ns2:Store"><Attribute1 xsi:type="xsd:string">attr1</Attribute1></output1>', $lastRequestInfo->getLastResponse());
        $this->assertStringContainsString('<output2 xsi:type="ns3:Store"><Attribute2 xsi:type="xsd:string">attr2</Attribute2></output2>', $lastRequestInfo->getLastResponse());
    }
